...
class ConnectionManager
{
	...
	{
		return $this->byId( "stock_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "stock_at_localhost";
		$data["connName"] = "stock at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;root;;stock;;1"; //currently unused

		$this->_connectionsIdByName["stock at localhost"] = "stock_at_localhost";
...
;
		...
		$connectionsData["stock_at_localhost"] = $data;
	...
	{
		$connectionsIds = array();
		$connectionsIds["product"] = "stock_at_localhost";
		$connectionsIds["company"] = "stock_at_localhost";
		$connectionsIds["dep"] = "stock_at_localhost";
		$connectionsIds["maindp"] = "stock_at_localhost";
		$connectionsIds["grouppro"] = "stock_at_localhost";
		$connectionsIds["inpro"] = "stock_at_localhost";
		$connectionsIds["outpro"] = "stock_at_localhost";
		$connectionsIds["lostpro"] = "stock_at_localhost";
		$connectionsIds["in"] = "stock_at_localhost";
		$connectionsIds["out"] = "stock_at_localhost";
		$connectionsIds["lost"] = "stock_at_localhost";
		$connectionsIds["stock_users"] = "stock_at_localhost";
		$connectionsIds["pro"] = "stock_at_localhost";
		$connectionsIds["inexpire"] = "stock_at_localhost";
		$connectionsIds["inexpireweak"] = "stock_at_localhost";
		$connectionsIds["View"] = "stock_at_localhost";
		$connectionsIds["in1"] = "stock_at_localhost";
		$connectionsIds["inexpire3month"] = "stock_at_localhost";
		$connectionsIds["product1"] = "stock_at_localhost";
		$connectionsIds["View1"] = "stock_at_localhost";
		$connectionsIds["inpro1"] = "stock_at_localhost";
		$connectionsIds["outpro1"] = "stock_at_localhost";
		$connectionsIds["in2"] = "stock_at_localhost";
		$connectionsIds["out1"] = "stock_at_localhost";
		$connectionsIds["lostpro1"] = "stock_at_localhost";
		$connectionsIds["lost1"] = "stock_at_localhost";
		$connectionsIds["product2"] = "stock_at_localhost";
